...
<#macro layout>
    ...
    <div class="layui-card-header">users
    ...
    <td>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="nick_name" name="nick_name"  lay-verify-min="0" lay-verify-max="50" lay-verify="string"  autocomplete="off"  class="layui-input"
            </div>
        </div>
    </td>
</tr>
...
<tr>
    <td>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="name" name="name"  lay-verify-min="0" lay-verify-max="50" lay-verify="string"  autocomplete="off"  class="layui-input"
            </div>
        </div>
    </td>
</tr>
...
<#macro jsLayout>
    ...
    <script>
        ...
        var dialogSaveParam = {
         ...
         app.use(['ajax_table', 'table', 'jquery', 'layer', 'form', 'ajax', 'app_util', 'app'],function () {
            ...
            table.on('tool(table_filter)', function(obj){
                ...
                if(layEvent === 'del'){
                    layer.confirm('真的删除行么', function (index) {
                         layer.close(index);
                        //向服务端发送删除指令
                        ajax.post_json('users/deleteByPrimaryKey', {id: data.id}, function(d){
