                ...
                <tr>
                    ...
                    <td >
                        <div class="layui-input-inline">
                            <input type="text" id="nick_name" name="nick_name"  lay-verify-min="0" lay-verify-max="50" lay-verify="required|string"  autocomplete="off" class="layui-input">
                        </div>
                    </td>
                </tr>
<tr>
                    ...
                    <td >
                        <div class="layui-input-inline">
                            <input type="text" id="password" name="password"  lay-verify-min="0" lay-verify-max="50" lay-verify="string"  autocomplete="off" class="layui-input">
                        </div>
                    </td>
                </tr>
<tr>
                    ...
                    <td >
                        <div class="layui-input-inline">
                            <input type="text" id="name" name="name"  lay-verify-min="0" lay-verify-max="50" lay-verify="required|string"  autocomplete="off" class="layui-input">
                        </div>
                    </td>
                </tr>
    ...
    <script>
        app.use(['ajax', 'jquery', 'layer', 'form', 'laydate'],function(){
            ...
            if(id === undefined || id == null ){
                url = 'users/insertChanged';
            }else{
                url = 'users/updateByPrimaryKeyChanged';
                load(id, ajax, $, layer);
            }
        ...
        function load(id, ajax, $, layer){
            ...
            ajax.post_json('users/getByPrimaryKey', {id:id}, function(d){
                ...
                $('#nick_name').val(d.result.data.nick_name || '');
$('#password').val(d.result.data.password || '');
