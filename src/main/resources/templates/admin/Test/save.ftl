    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <table class="layui-table">
                <tr>
                    <td style="width:50px;">
                        <label class="admin-form-label" >cb1</label>
                    </td>
                    <td >
                        <div class="layui-input-inline">
                            <input type="text" id="c1" name="c1"  lay-verify-min="0" lay-verify-max="100" lay-verify="required|string"  autocomplete="off" class="layui-input">
                        </div>
                    </td>
                </tr>
<tr>
                    <td style="width:50px;">
                        <label class="admin-form-label" >cb2</label>
                    </td>
                    <td >
                        <div class="layui-input-inline">
...
<tr>
                    <td style="width:50px;">
                        <label class="admin-form-label" >cb3</label>
                    </td>
                    <td >
                        <div class="layui-input-inline">
                            <input type="text" id="c3" name="c3"  lay-verify-min="-9999999999999999" lay-verify-max="9999999999999999" lay-verify="decimal"  autocomplete="off" class="layui-input">
                        </div>
                    </td>
                </tr>
<tr>
                    <td style="width:50px;">
                        <label class="admin-form-label" >cb4</label>
                    </td>
                    <td >
                        <div class="layui-input-inline">
...
<tr>
                    <td style="width:50px;">
                        <label class="admin-form-label" >cb5</label>
                    </td>
                    <td >
                        <div class="layui-input-inline">
...
<tr>
                    <td style="width:50px;">
                        <label class="admin-form-label" >cb6</label>
                    </td>
                    <td >
                        <div class="layui-input-inline">
...
laydate.render({
            ...
            if(id === undefined || id == null ){
                url = 'Test/insertChanged';
            }else{
                url = 'Test/updateByPrimaryKeyChanged';
                load(id, ajax, $, layer);
            }
        ...
        function load(id, ajax, $, layer){
            var index = layer.load();
            ajax.post_json('Test/getByPrimaryKey', {id:id}, function(d){
                layer.close(index);
                //console.log(d);
                if(d.code === 'fail'){
                    layer.msg("获取信息错误:" + d.msg);
