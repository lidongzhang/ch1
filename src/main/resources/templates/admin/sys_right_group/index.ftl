...
<#macro layout>
    ...
    <div class="layui-card-header">权限组
    ...
    <td>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="name" name="name"  lay-verify-min="0" lay-verify-max="200" lay-verify="string"  autocomplete="off"  class="layui-input"
            </div>
        </div>
    </td>
</tr>
        ...
        var dialogSaveParam = {
         ...
         app.use(['ajax_table', 'table', 'jquery', 'layer', 'form', 'ajax', 'app_util'],function () {
            ...
            var cols = [[
                        ...
                        ,{fixed: 'right', width:210, align:'center', toolbar: '#operate_buttons'}
                        ]];
            ...
            form.on('submit(search_button)', function(data){
                ...
                ajax_table.post({
                    eleId:'#table_select',
                    url: 'sys_right_group/selectPageByMap',
                    id: 'id',
            ...
            table.on('tool(table_filter)', function(obj){
                ...
                if(layEvent === 'del'){
                    layer.confirm('真的删除行么', function (index) {
                         layer.close(index);
                        //向服务端发送删除指令
                        ajax.post_json('sys_right_group/deleteByPrimaryKey', {id: data.id}, function(d){
